const builtInStrategies = {
    'unbounded': ({ queue, incoming }) => {
        return [...queue, incoming];
    },
    'drop-head': ({ queue, incoming, maxSize = 10 }) => {
        const next = [...queue, incoming];
        return next.slice(-maxSize);
    },
    'drop-tail': ({ queue, incoming, maxSize = 10 }) => {
...
//# sourceMappingURL=stream-task.js.map